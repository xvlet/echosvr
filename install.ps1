...
$InstallDir = if ($env:ECHOSVR_INSTALL_DIR) { $env:ECHOSVR_INSTALL_DIR } else { "$env:USERPROFILE\.local\bin" }

Write-Host ""
Write-Host "       _                               "
Write-Host "  ___ | |__   ___  ___ __   __ _ __    "
Write-Host " / _ \| '_ \ / _ \/ __|\ \ / /| '__| "
Write-Host "|  __/| | | | (_) \__ \ \ V / | |    "
Write-Host " \___||_| |_|\___/|___/  \_/  |_|    "
Write-Host "                                       "
Write-Host "                 echosvr installer ⚡"
...
$TempDir = Join-Path $env:TEMP "echosvr_install_$([guid]::NewGuid().ToString().Substring(0,8))"
