...
BIN="echosvr"
REPO="xvlet/echosvr"
INSTALL_DIR="${ECHOSVR_INSTALL_DIR:-$HOME/.local/bin}"

main() {
    echo ""
    echo "       _                               "
    echo "  ___ | |__   ___  ___ __   __ _ __    "
    echo " / _ \\| '_ \\ / _ \\/ __|\\ \\ / /| '__| "
    echo "|  __/| | | | (_) \\__ \\ \\ V / | |    "
    echo " \\___||_| |_|\\___/|___/  \\_/  |_|    "
    echo "                                       "
    echo "                 echosvr installer ⚡"
    echo "              github.com/xvlet/echosvr"
    echo ""
    ...
    if command -v "$BIN" >/dev/null 2>&1; then
        echo ""
        log "ready. run 'echosvr' to get started."
    fi
